...
const ReadMorePosts = ({ post }) => {
    ...
    return (
        <>
            ...
            {data && !error && (
                <div className="container justify-center items-center flex flex-wrap md:flex-nowrap gap-6 mx-auto text-center ">
                    <div className="max-w-[600px] px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2">
                        ...
                        <p className="font-serif	text-right italic text-xs font-bold">
                            {data.author}
                        </p>
                    </div>
                    <img
